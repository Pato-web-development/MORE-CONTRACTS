...
async function main() {
    ...
    const getcontract = await ethers.getContractFactory("SafeFinance5");
    ...
    const getUSDCcontractAddress = await ethers.getContractAt("IERC20", "0x64544969ed7EBf5f083679233325356EbE738930");
    getUSDCcontractAddress.approve(getcontractaddress, ethers.utils.parseUnits("100000000", 18));
