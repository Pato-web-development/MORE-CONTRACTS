...
contract Web3Token is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Web3 Finance", "WEB3T") ERC20Permit("Safe Finance") {
    ...
    function buyTokenWithToken(address _tokenContractAddress, uint256 _tokenAmount) internal {
        ...
        function SwapTokenWithUSDT(uint256 _tokenAmount) public {
        buyTokenWithToken(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd, _tokenAmount);
    }

     function SwapTokenWithBUSD(uint256 _tokenAmount) public {
        buyTokenWithToken(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee, _tokenAmount);
    }

     function SwapTokenWithPATO(uint256 _tokenAmount) public {
